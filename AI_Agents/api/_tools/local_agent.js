...
function buildGeneratePrompt(job, g, snapshot, existing, liveWalk, liveTrace) {
  ...
  return [
    ...
    '- CLEAN CODE: consistent indentation matching the exemplars, no unused imports, no dead code, no duplicated boilerplate that belongs in a shared helper. Add a SHORT one-line comment only above a genuinely non-obvious step (why a wait/sequence is needed) — do not over-comment obvious lines.',
